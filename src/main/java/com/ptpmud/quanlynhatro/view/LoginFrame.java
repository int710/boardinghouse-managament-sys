...
import com.ptpmud.quanlynhatro.controller.AuthController;
...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Đăng Nhập - Hệ Thống Quản Lý Nhà Trọ");
        setBackground(new java.awt.Color(255, 255, 255));

        footerPanel.setBackground(new java.awt.Color(204, 204, 204));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 2, 12)); // NOI18N
        jLabel2.setText("© 2025 KMA - Phát Triển Phần Mềm Ứng Dụng");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/logoKMA.jpg"))); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        TaiKhoan tk = controller.handleLogin(u, p);
        if (tk == null) {
            JOptionPane.showMessageDialog(this, "Sai tài khoản hoặc mật khẩu!");
        } else {
            JOptionPane.showMessageDialog(this, "Đăng nhập thành công!");
            AppController.openUIByRole(tk);
